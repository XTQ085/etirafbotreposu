...
İtiraf_aciq = b""
@client.on(events.callbackquery.CallbackQuery(data="aciq"))
async def aciq(event):
    global mesaj
    global tesdiq
    async for usr in client.iter_participants(event.chat_id):
     İtiraf_eden = f"[{usr.first_name}](tg://user?id={usr.id})"
